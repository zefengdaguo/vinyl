<template>
    <div>
        ...
        <div style="width: 840px; margin: 0 auto">
            <h1 style="font-size: 26px; color: #333; margin-left: 20px">添加影人</h1>
            ...
            <el-main>
                ...
                <el-form-item>
                    ...
                    <img v-if="form.profilePath" :src="'/api/profile/'+form.profilePath" class="avatar">
                    </el-upload>
                </el-form-item>
...
export default {
    ...
    methods: {
      ...
      submit() {
          this.$axios.post("/person/add",this.form).then(() => {
            this.$message('提交成功');
          });
      }
    },
